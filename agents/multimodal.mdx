...
| Content Type | OpenAI | Anthropic | Google/Vertex | Ollama |
|-------------|--------|-----------|---------------|--------|
| **Image** (URL) | Yes | Yes | Yes | No |
| **Image** (base64) | Yes | Yes | Yes | Yes |
| **Audio** (base64) | Yes | No | Yes | No |
| **File** (URL) | Yes | Yes | Yes | No |
| **File** (base64) | Yes | Yes | Yes | No |

...
```typescript
import { VoiceAgent, openaiRealtime, CostTracker } from "@radaros/core";
...
console.log(summary.byAgent["assistant"].cost);
console.log(summary.byAgent["assistant"].breakdown.audioInput);
console.log(summary.byAgent["assistant"].breakdown.audioOutput);
```
